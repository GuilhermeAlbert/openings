...
assert.match(redirects, /^\/authors\/\s+\/listing-indexes\/authors\/\s+200$/mu);
assert.match(redirects, /^\/users\/\s+\/listing-indexes\/users\/\s+200$/mu);
assert.match(redirects, /^\/communities\/\s+\/listing-indexes\/communities\/\s+200$/mu);
assert.match(redirects, /^\/community\/\s+\/listing-indexes\/community\/\s+200$/mu);
